...
local previous_formation
local colorArr = {[0] = colors.green, colors.purple, colors.red, colors.blue, colors.yellow, colors.cyan}
...
function loop() 
	...
	if start_formations then
		...
		previous_formation = current_formation % 6
		fillMatrix(colors.black)
		setDig (previous_formation, colorArr[previous_formation])
		updateMatrix()
		-- sleep (0.1)
	end
end
