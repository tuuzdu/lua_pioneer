--[[
Данный файл взят с сайта https://learnxinyminutes.com/docs/ru-ru/lua-ru/
Здесь представлен базовый синтаксис и механики языка Lua.

Программирование Пионера специфично, поэтому некоторые из описанных здесь вещей неактуальны для него. Так, в Пионере не используются библиотеки ввода-вывода (io), работа с файлами, не имеет смысла функция print и т.д.

Из стандартных библиотек доступны: base (базовая), table (работа с таблицами), string (работа со строками) и math (математические функции)

На сайте https://pioneer-doc.readthedocs.io/ru/master/programming/lua/lua.html представлено API взаимодействия с автопилотом Пионера.

Удачи в изучении языка Lua и программировании квадрокоптера Пионер!
]]
