...
function Path:eventHandler( e )
	...
	if change_state then
		...
		if obj_state.waypoint then
			ap.goToLocalPoint( unpack(self.point[self.state]) )
...
my_path:addTakeoff()						-- Взлет. После взлета зажечь светодиоды красным цветом
my_path:addWaypoint(0.5, 0.5, 1)		-- Следовать к точке. После достижения - зажечь светодиоды синим цветом
my_path:addWaypoint(-0.5, 0.5, 1)		-- Следовать к точке. После достижения - зажечь светодиоды красным цветом
